<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuanLySinhVien2.aspx.cs" Inherits="QuanLySinhVien" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Xml ID="Xml1" runat="server"
            DocumentSource="~/xml/SinhVien.xml"
            TransformSource="~/xslt/QuanLySinhVien.xslt"></asp:Xml>
        <div class="form">
            <h1>
